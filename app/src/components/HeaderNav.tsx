          ...
          {tabs.map((tab) => {
            ...
            return (
              <a
                key={tab.id}
                data-tab={tab.id}
                className={`flex flex-col items-start gap-1 pb-2 font-label-caps text-label-caps transition-colors duration-300 active:scale-95 hover:text-primary dark:hover:text-primary-fixed ${
                  isActive
